...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="p-2 rounded-xl text-slate-500 hover:bg-slate-100 dark:hover:bg-white/10 dark:text-slate-400 transition-colors flex items-center justify-center w-10 h-10"
